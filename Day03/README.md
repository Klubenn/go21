...
### Exercise 00: Loading data into a database
...
### Exercise 03: Searching for three closest restaurants
...
- Your application should never return HTTP 200 if there is an error or anything other than 200 if there is none
